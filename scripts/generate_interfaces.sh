...
#     -p ${ROOT_PROJECT_DIRECTORY}/user_service/internal/repositories \
#     -i UserRepository \
#     -t ${GO_DECORATORS_TEMPLATE_DIRECTORY}/logerr_cleaner.go \
#     -o ${ROOT_PROJECT_DIRECTORY}/user_service/internal/repositories/decorators/logerr_cleaner${GENERATED_DECORATORS_EXTENTION}
...
#     -i UserService \
#     -t ${GO_DECORATORS_TEMPLATE_DIRECTORY}/logerror_logger.go \
#     -o ${ROOT_PROJECT_DIRECTORY}/user_service/internal/services/decorators/logerror_logger${GENERATED_DECORATORS_EXTENTION}

# ${GO_WRAP_BINARY} gen \
#     -p ${ROOT_PROJECT_DIRECTORY}/user_service/internal/services \
#     -i UserService \
#     -t ${GO_DECORATORS_TEMPLATE_DIRECTORY}/logerr_cleaner.go \
#     -o ${ROOT_PROJECT_DIRECTORY}/user_service/internal/services/decorators/logerr_cleaner${GENERATED_DECORATORS_EXTENTION}
...
#     -i UserController \
#     -t ${GO_DECORATORS_TEMPLATE_DIRECTORY}/logerror_logger.go \
#     -o ${ROOT_PROJECT_DIRECTORY}/user_service/internal/controllers/decorators/logerror_logger${GENERATED_DECORATORS_EXTENTION}

# ${GO_WRAP_BINARY} gen \
#     -p ${ROOT_PROJECT_DIRECTORY}/user_service/internal/controllers \
#     -i UserController \
#     -t ${GO_DECORATORS_TEMPLATE_DIRECTORY}/logerr_cleaner.go \
#     -o ${ROOT_PROJECT_DIRECTORY}/user_service/internal/controllers/decorators/logerr_cleaner${GENERATED_DECORATORS_EXTENTION}
...
#     -i AccountRepository \
#     -t ${GO_DECORATORS_TEMPLATE_DIRECTORY}/logerror_logger.go \
#     -o ${ROOT_PROJECT_DIRECTORY}/auth_service/internal/repositories/decorators/logerror_logger${GENERATED_DECORATORS_EXTENTION}

# ${GO_WRAP_BINARY} gen \
#     -p ${ROOT_PROJECT_DIRECTORY}/auth_service/internal/repositories \
#     -i AccountRepository \
#     -t ${GO_DECORATORS_TEMPLATE_DIRECTORY}/logerr_cleaner.go \
#     -o ${ROOT_PROJECT_DIRECTORY}/auth_service/internal/repositories/decorators/logerr_cleaner${GENERATED_DECORATORS_EXTENTION}
...
#     -i AccountService \
#     -t ${GO_DECORATORS_TEMPLATE_DIRECTORY}/logerror_logger.go \
#     -o ${ROOT_PROJECT_DIRECTORY}/auth_service/internal/services/decorators/logerror_logger${GENERATED_DECORATORS_EXTENTION}

# ${GO_WRAP_BINARY} gen \
#     -p ${ROOT_PROJECT_DIRECTORY}/auth_service/internal/services \
#     -i AccountService \
#     -t ${GO_DECORATORS_TEMPLATE_DIRECTORY}/logerr_cleaner.go \
#     -o ${ROOT_PROJECT_DIRECTORY}/auth_service/internal/services/decorators/logerr_cleaner${GENERATED_DECORATORS_EXTENTION}
...
#     -i AccountController \
#     -t ${GO_DECORATORS_TEMPLATE_DIRECTORY}/logerror_logger.go \
#     -o ${ROOT_PROJECT_DIRECTORY}/auth_service/internal/controllers/decorators/logerror_logger${GENERATED_DECORATORS_EXTENTION}

# ${GO_WRAP_BINARY} gen \
#     -p ${ROOT_PROJECT_DIRECTORY}/auth_service/internal/controllers \
#     -i AccountController \
#     -t ${GO_DECORATORS_TEMPLATE_DIRECTORY}/logerr_cleaner.go \
#     -o ${ROOT_PROJECT_DIRECTORY}/auth_service/internal/controllers/decorators/logerr_cleaner${GENERATED_DECORATORS_EXTENTION}

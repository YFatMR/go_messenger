...
func (c *userClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*UserDataResponse, error) {
...
func (UnimplementedUserServer) CreateUser(context.Context, *CreateUserRequest) (*UserDataResponse, error) {

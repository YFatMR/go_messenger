...
func RegisterFrontUserHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FrontUserServer) error {
	...
	mux.Handle("POST", pattern_FrontUser_CreateUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/go_proto.FrontUser/CreateUser", runtime.WithHTTPPathPattern("/user"))
		if err != nil {
...
func RegisterFrontUserHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FrontUserClient) error {
	...
	mux.Handle("POST", pattern_FrontUser_CreateUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/go_proto.FrontUser/CreateUser", runtime.WithHTTPPathPattern("/user"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_FrontUser_CreateUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"user"}, ""))
)

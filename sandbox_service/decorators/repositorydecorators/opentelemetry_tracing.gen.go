...
//go:generate gowrap gen -p github.com/YFatMR/go_messenger/sandbox_service/apientity -i SandboxRepository -t ../../../core/pkg/decorators/templates/opentelemetry_tracing.template.go -o opentelemetry_tracing.gen.go -l ""

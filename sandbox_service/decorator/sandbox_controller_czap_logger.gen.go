...
//go:generate gowrap gen -p github.com/YFatMR/go_messenger/sandbox_service/apientity -i SandboxController -t ../../core/pkg/decorators/templates/czap_logger.template.go -o sandbox_controller_czap_logger.gen.go -l ""

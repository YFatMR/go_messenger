...
//go:generate gowrap gen -p github.com/YFatMR/go_messenger/user_service/internal/services -i UserService -t ../../../../core/pkg/decorators/templates/common/opentelemetry_tracing.go -o opentelemetry_tracing.gen.go -l ""
